...
class LocalAttention(nn.Module):
    """
    Multi-headed attention with distance penalty.
    """

    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, penalty=None, **kwargs):
        super().__init__()
    ...
    def forward(self, query, key, value,
        ...
        query, key and value. Padding elements can be excluded from
        the key by passing a binary ByteTensor (`key_padding_mask`) with shape:
        batch x src_len, where padding elements are indicated by 1s.
        """
        # TODO: add support to attn_mask
